...
# Click message icon
adb -s $PHONE_ID shell input tap 946 1834
sleep 1
...
adb -s $PHONE_ID shell input tap 541 383
sleep 1
...
# Click most message bar/box
adb -s $PHONE_ID shell input tap 523 1848
sleep 1
...
do
    ...
    adb -s $PHONE_ID shell input tap 988 1060
    sleep $num2
done
sleep 5
