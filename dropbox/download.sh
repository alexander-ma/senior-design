...
# Tap on file ...
adb -s $PHONE_ID input tap 1000 1075
# Swipe up on more options
adb -s $PHONE_ID input swipe 600 1300 600 600 1000
# Tap on Export
adb -s $PHONE_ID input tap 540 1500
# Tap on Save to device
adb -s $PHONE_ID input tap 550 330
# Tap on Save
adb -s $PHONE_ID input tap 945 1830
